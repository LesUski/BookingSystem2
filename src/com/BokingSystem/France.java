...
public class France extends Country {
    ...
    public void getTravellingOptions() {
        ...
        if (input == 1) {
            File file = new File("src/com/BokingSystem/DateFiles/franceDatesFlight.txt");
            getDates(file);
        }
        if (input == 2) {
            File file = new File("src/com/BokingSystem/DateFiles/franceDatesTrain.txt");
            getDates(file);
        }
        if (input == 3) {
            File file = new File("src/com/BokingSystem/DateFiles/franceDatesBus.txt");
            getDates(file);
        }
        return;
    }
