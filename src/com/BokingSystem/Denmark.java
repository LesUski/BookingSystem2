...
public class Denmark extends Country{
    ...
    public void getTravellingOptions() {
        ...
        if (input == 1) {
            File file = new File("src/com/BokingSystem/DateFiles/denmarkDatesFlight.txt");
            getDates(file);
        }
        if (input == 2) {
            File file = new File("src/com/BokingSystem/DateFiles/denmarkDatesTrain.txt");
            getDates(file);
        }
        if (input == 3) {
            File file = new File("src/com/BokingSystem/DateFiles/denmarkDatesBus.txt");
            getDates(file);
        }
        return;
    }
