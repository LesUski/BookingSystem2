...
public class Finland extends Country {
    ...
    public void getTravellingOptions() {
        ...
        if (input == 1) {
            File file = new File("src/com/BokingSystem/DateFiles/finlandDatesFlight.txt");
            getDates(file);
        }
        if (input == 2) {
            File file = new File("src/com/BokingSystem/DateFiles/finlandDatesFerry.txt");
            getDates(file);
        }
        if (input == 3) {
            File file = new File("src/com/BokingSystem/DateFiles/finlandDatesBus.txt");
            getDates(file);
        }
        return;
    }
